...
export namespace Components {
    interface DuetDatePicker {
        ...
        "role": string;
        /**
          * Makes the date picker select whole weeks instead of single days. Value formatted as 20XX-WXX (e.g. 2024-W08)
         */
...
declare namespace LocalJSX {
    interface DuetDatePicker {
         ...
         */
        "onDuetClose"?: (event: DuetDatePickerCustomEvent<DuetDatePickerCloseEvent>) => void;
        /**
         ...
         */
        "onDuetOpen"?: (event: DuetDatePickerCustomEvent<DuetDatePickerOpenEvent>) => void;
        /**
          * Should the input be marked as required?
         */
        "required"?: boolean;
