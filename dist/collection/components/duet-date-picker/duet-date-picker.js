    ...
    return {
      ...
      "localization": {
        ...
        "complexType": {
          ...
          "resolved": "{ buttonLabel: string; placeholder: string; weekPlaceholder: string; selectedDateMessage: string; prevMonthLabel: string; nextMonthLabel: string; monthSelectLabel: string; yearSelectLabel: string; closeLabel: string; calendarHeading: string; dayNames: DayNames; monthNames: MonthsNames; monthNamesShort: MonthsNames; locale: string | string[]; }",
          "references": {
            "DuetLocalizedText": {
              "location": "import",
      ...
      "selectByWeek": {
        ...
        "docs": {
          "tags": [],
          "text": "Makes the date picker select whole weeks instead of single days.\nValue formatted as 20XX-WXX (e.g. 2024-W08)"
        },
        "attribute": "select-by-week",
        "reflect": false,
        "defaultValue": "false"
      }
    };
