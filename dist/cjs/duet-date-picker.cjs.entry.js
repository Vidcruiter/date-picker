...
const DatePickerInput = ({ onClick, dateFormatter, localization, name, formattedValue, valueAsDate, value, identifier, disabled, required, role, buttonRef, inputRef, onInput, onBlur, onFocus, selectByWeek, firstDayOfWeek, }) => {
  ...
  return (index.h("div", { class: "duet-date__input-wrapper" },
    index.h("input", { class: "duet-date__input", value: formattedDate, placeholder: selectByWeek ? localization.weekPlaceholder : localization.placeholder, id: identifier, disabled: disabled, role: role, required: required ? true : undefined, "aria-autocomplete": "none", onInput: onInput, onFocus: onFocus, onBlur: onBlur, autoComplete: "off", ref: inputRef }),
    index.h("input", { type: "hidden", name: name, value: actualValue }),
...
const DatePickerMonth = ({ selectedDate, focusedDate, labelledById, localization, firstDayOfWeek, min, max, dateFormatter, isDateDisabled, onDateSelect, onKeyboardNavigation, focusedDayRef, selectByWeek, }) => {
  ...
  return (index.h("table", { class: "duet-date__table", "aria-labelledby": labelledById },
    ...
    index.h("tbody", null, chunk(days, 7).map(week => (index.h("tr", { class: {
        "duet-date__row": true,
        "select-by-week": selectByWeek,
      } }, week.map(day => (index.h("td", { class: "duet-date__cell" },
      index.h(DatePickerDay, { day: day, today: today, focusedDay: focusedDate, isSelected: isEqual(day, getSelectedDate(day)), disabled: isDateDisabled(day), inRange: inRange(day, min, max), onDaySelect: onDateSelect, dateFormatter: dateFormatter, onKeyboardNavigation: onKeyboardNavigation, focusedDayRef: focusedDayRef }))))))))));
};
