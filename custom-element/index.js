...
const DatePickerInput = ({ onClick, dateFormatter, localization, name, formattedValue, valueAsDate, value, identifier, disabled, required, role, buttonRef, inputRef, onInput, onBlur, onFocus, selectByWeek, firstDayOfWeek, }) => {
  ...
  return (h("div", { class: "duet-date__input-wrapper" },
    ...
    h("input", { type: "hidden", name: name, value: actualValue }),
...
const DatePickerMonth = ({ selectedDate, focusedDate, labelledById, localization, firstDayOfWeek, min, max, dateFormatter, isDateDisabled, onDateSelect, onKeyboardNavigation, focusedDayRef, selectByWeek, }) => {
  ...
  return (h("table", { class: "duet-date__table", "aria-labelledby": labelledById },
    ...
    h("tbody", null, chunk(days, 7).map(week => (h("tr", { class: {
        "duet-date__row": true,
        "select-by-week": selectByWeek,
      } }, week.map(day => (h("td", { class: "duet-date__cell" },
      h(DatePickerDay, { day: day, today: today, focusedDay: focusedDate, isSelected: isEqual(day, getSelectedDate(day)), disabled: isDateDisabled(day), inRange: inRange(day, min, max), onDaySelect: onDateSelect, dateFormatter: dateFormatter, onKeyboardNavigation: onKeyboardNavigation, focusedDayRef: focusedDayRef }))))))))));
};
...
const DuetDatePicker = /*@__PURE__*/proxyCustomElement(DuetDatePicker$1, [0,"duet-date-picker",{"name":[1],"identifier":[1],"disabled":[516],"role":[1],"direction":[1],"required":[4],"value":[1537],"min":[1],"max":[1],"firstDayOfWeek":[2,"first-day-of-week"],"localization":[16],"dateAdapter":[16],"isDateDisabled":[16],"selectByWeek":[4,"select-by-week"],"activeFocus":[32],"focusedDay":[32],"open":[32]},[[6,"click","handleDocumentClick"]]]);
...
export { DuetDatePicker, defineCustomElements };
